...
void fish(){
    glPushMatrix();
      ...
      glBegin(GL_TRIANGLES);
		...
		glColor3ub(255,255,255);
		glVertex2f(21.9 + fishX,-51.9);
		glVertex2f(22.9 + fishX,-49.9);
        glVertex2f(21.9 + fishX,-47.9);
...
void keyboard( unsigned char key, int x, int y ){
    ...
    case 'b':
        ...
        break;
    case 'C':
        cloudScale = true; //cloud run
         glutPostRedisplay();
        break;
    case 'c':
        cloudScale = false; //cloud stop
         glutPostRedisplay();
        break;
    case 'P':
    ...
    case 'p':
        ...
        break;
    case 'F':
        fishScale = true; //fish run
         glutPostRedisplay();
        break;
    case 'f':
        fishScale = false; //fish stop
         glutPostRedisplay();
        break;
    case 'S':
        sunScale = true; //sun down
         glutPostRedisplay();
        break;
    case 's':
        sunScale = false; //moon stop
         glutPostRedisplay();
        break;
    }
